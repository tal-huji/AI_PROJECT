...
class DQNAgent(Agent):
    def __init__(self, train_env, test_env, state_shape, action_size):
    ...
    def train_agent(self):
        ...
        for episode in range(n_episodes):
            ...
            if episode == n_episodes - 1:  # If it's the last episode, store the values for plotting
        ...
        return last_episode_portfolio_values  # Return values from the last episode only
    ...
    def test_agent(self):
        ...
        state, _ = self.test_env.reset(seed=hyperparams['seed'])
        state = state.flatten()
