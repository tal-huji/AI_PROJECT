...
#
# Dynamic Feature: Average True Range (ATR)
...
#         return 0.0
#     available_window = min(window, len(history) - 1)
#     return np.mean((history["data_close", -available_window:] - np.mean(history["data_close", -available_window:]))**3) / (np.std(history["data_close", -available_window:])**3)
#
...
#         return 0.0
#     available_window = min(window, len(history) - 1)
#     return np.mean((history["data_close", -available_window:] - np.mean(history["data_close", -available_window:]))**4) / (np.std(history["data_close", -available_window:])**4)
#
